...
public class ViewDragHelper {
	 ...
	 * callback's
	 * {@link com.xchat.swipeback.ViewDragHelper.Callback#onEdgeTouched(int, int)}
	 * and
	 * {@link com.xchat.swipeback.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
	 ...
	 * {@link com.xchat.swipeback.ViewDragHelper.Callback#tryCaptureView(android.view.View, int)}
	 ...
	 * {@link com.xchat.swipeback.ViewDragHelper.Callback#getOrderedChildIndex(int)}
	 * .
	 * 
	 * @param x
	 *            X position to test in the parent's coordinate system
